                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="col-span-2 ... py-10">
                        <div class="p-14">
                            ...
                            <hr>
                            <div class="text-center">Avarage rating is: <span class="text-blue-600 text-xl font-bold">{{ $avg }}</span></div>
                            <hr>
                                ...
                                <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
                                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                        ...
                                        <form wire:submit.prevent="saveRating">
                                            @csrf
                                            <input wire:model="book_id" type="hidden" name="book_id">
                                            <!-- Rate -->
                                            <div class="m-2">
                                                <x-label for="rate" :value="__('Rate')" />

                                                <select wire:model="rate" name="rate" id="rate" class="form-select block w-full mt-1 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                            ...
                                            <div class="m-2">
                                                ...
                                                <textarea wire:model="review" id="review" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="review" required rows="5"></textarea>
                                            </div>
